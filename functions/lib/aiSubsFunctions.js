...
async function fetchYouTubeSubtitles(videoId) {
    ...
    try {
        ...
        const segments = (_b = (_a = transcript.content) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.initial_segments;
        ...
        if (error.message === 'NO_CAPTIONS_AVAILABLE' ||
            ((_c = error.message) === null || _c === void 0 ? void 0 : _c.includes('Could not find captions')) ||
            ((_d = error.message) === null || _d === void 0 ? void 0 : _d.includes('Transcript is disabled')) ||
            ((_e = error.message) === null || _e === void 0 ? void 0 : _e.includes('transcripts are disabled'))) {
 ...
 */
async function translateSubtitles(subtitles, targetLanguage, translationStyle = 'standard', videoTopic) {
    var _a;
...
exports.translateVideoSubtitles = functions.https.onRequest((request, response) => {
    corsHandler(request, response, async () => {
        ...
        try {
            ...
            const { userId, userTier, videoSource, youtubeUrl, videoId: providedVideoId, targetLanguage, translationStyle = 'standard', videoTopic, } = request.body;
            ...
            if (videoSnap.exists) {
                ...
                if ((videoData === null || videoData === void 0 ? void 0 : videoData.translations) && videoData.translations[translationKey]) {
            ...
            const { translatedSubtitles, tokensUsed } = await translateSubtitles(originalTranscript, targetLanguage, translationStyle, videoTopic);
