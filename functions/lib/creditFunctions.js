...
exports.trackDeviceLogin = exports.grantAdWatchCredits = exports.grantSecondTrialCredits = exports.grantTrialCredits = void 0;
 ...
 */
exports.grantTrialCredits = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const result = await db.runTransaction(async (transaction) => {
            ...
            if (!(antifraud === null || antifraud === void 0 ? void 0 : antifraud.phone_verified)) {
            ...
            // Grant trial credits
            const now = admin.firestore.Timestamp.now();
            const expiresAt = new admin.firestore.Timestamp(now.seconds + TRIAL_CONFIG.EXPIRY_DAYS * 24 * 60 * 60, now.nanoseconds);
            ...
            transaction.set(db.collection('creditTransactions').doc(), {
                ...
                balanceBefore: {
                    trial: 0,
                    monthly: ((_b = (_a = userData.credits) === null || _a === void 0 ? void 0 : _a.monthly) === null || _b === void 0 ? void 0 : _b.amount) || 0,
                    purchase: ((_d = (_c = userData.credits) === null || _c === void 0 ? void 0 : _c.purchase) === null || _d === void 0 ? void 0 : _d.amount) || 0,
                    total: ((_e = userData.credits) === null || _e === void 0 ? void 0 : _e.total) || 0,
                },
                balanceAfter: {
                    trial: TRIAL_CONFIG.FIRST_GRANT,
                    monthly: ((_g = (_f = userData.credits) === null || _f === void 0 ? void 0 : _f.monthly) === null || _g === void 0 ? void 0 : _g.amount) || 0,
                    purchase: ((_j = (_h = userData.credits) === null || _h === void 0 ? void 0 : _h.purchase) === null || _j === void 0 ? void 0 : _j.amount) || 0,
                    total: (((_k = userData.credits) === null || _k === void 0 ? void 0 : _k.total) || 0) + TRIAL_CONFIG.FIRST_GRANT,
                },
                createdAt: now,
            });
 ...
 */
exports.grantSecondTrialCredits = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    const userId = context.auth.uid;
    try {
        const result = await db.runTransaction(async (transaction) => {
            ...
            const newExpiresAt = new admin.firestore.Timestamp(now.seconds + TRIAL_CONFIG.EXPIRY_DAYS * 24 * 60 * 60, now.nanoseconds);
            transaction.update(userRef, {
 ...
 */
exports.grantAdWatchCredits = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    const userId = context.auth.uid;
 ...
 */
exports.trackDeviceLogin = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    const userId = context.auth.uid;
...
//# sourceMappingURL=creditFunctions.js.map